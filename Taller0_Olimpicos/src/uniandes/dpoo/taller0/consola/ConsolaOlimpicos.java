...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarPaisQueRepresentaUnAtleta();
	...
	private void ejecutarPaisQueRepresentaUnAtleta() 
	{
		System.out.println("\n" + "País que representa un atleta" + "\n");
		
		String nombre = input("Ingrese el nombre del atleta");
		Pais pais = calculadora.paisQueRepresentaUnAtleta(nombre);
		System.out.println(nombre + " representa a " + pais.darNombre() + ".");
